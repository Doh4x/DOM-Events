...
focus срабатывает когда элемент получил фокус. blur когда потерял. Оба не всплывают - это их главная особенность. Если нужен делегированный обработчик на родителе - следует использовать focusin и focusout, они всплывают.
